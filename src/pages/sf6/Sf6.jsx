...
import "./Sf6.css";
import drive from "../../components/img/300px-SF6_Drive_Gauge.jpg"
  ...
  return (
    <div className="page">
      ...
      <main className="sf-content">
        ...
        <section id="fighters" className="sf6-fighters-grid">
        ...
        <section className="sf6-mechanics-section">
          ...
          <img className="sf6-img" src={drive} alt="Drive Gauge" />
